...
export const FolderOpenIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 ${className}`}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h6.75m0 0l-3-3m3 3l3-3m-5.25 3H3.75c-.621 0-1.125.504-1.125 1.125v3.75c0 .621.504 1.125 1.125 1.125h16.5c.621 0 1.125-.504 1.125-1.125V6.75A2.25 2.25 0 0 0 19.5 4.5h-6.75a2.25 2.25 0 0 0-2.25 2.25v.75" />
  </svg>
);
